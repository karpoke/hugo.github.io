...
- [Recover deleted photos from an Android device][vídeo donde se explica cómo abrirlas]
- [Best way to remove bytes from the start of a file?][eliminar los 6 primeros bytes]
